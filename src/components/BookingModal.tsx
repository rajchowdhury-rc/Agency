              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-3.5 rounded-full bg-[#141F2D] hover:bg-[#1E2E42] text-[#FAF8F5] font-semibold text-sm transition-all flex items-center justify-center gap-2 shadow-card disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
